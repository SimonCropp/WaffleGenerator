...
#endif
{
    public class WaffleEngine
    {
        ...
        static string[] firstAdjectivePhrases =
        {
        ...
        static string[] secondAdjectivePhrases =
        {
        ...
        static string[] cardinalSequences =
        {
            "one", "two", "three", "four", "five", "six",
            "seven", "eight", "nine", "ten", "eleven", "twelve"
        };

        static string[] ordinalSequences =
        {
            "first", "second", "third", "fourth", "fifth"
        };

        static string[] maybeHeading =
        {
            "", "", "\n<h2>The |uc.</h2>\n<p>", ""
        };

        static string[] maybeParagraph =
        {
            "", "", "|n", ""
        };
        ...
        {
            if (cardinalSequence >= cardinalSequences.Length)
            {
                cardinalSequence = 0;
            }

            output.Append(cardinalSequences[cardinalSequence++]);
        }

        void EvaluateOrdinalSequence(StringBuilder output)
        {
            if (ordinalSequence >= ordinalSequences.Length)
            {
                ordinalSequence = 0;
            }

            output.Append(ordinalSequences[ordinalSequence++]);
        }
